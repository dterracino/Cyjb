...
namespace Cyjb
{
    ...
    public static class CommonExceptions
    {
        ...
        /// <param name="paramName">产生异常的参数名称。</param>
        /// <returns><see cref="RankException"/> 对象。</returns>
        public static RankException MultidimensionalArrayNotSupported([CanBeNull] [InvokerParameterName] string paramName)
        {
            Contract.Ensures(Contract.Result<RankException>() != null);
            string message;
            if (paramName == null)
        ...
        public static ArgumentOutOfRangeException ArgumentMustBePositive([InvokerParameterName] string paramName, object actualValue)
        {
        ...
        /// <param name="actualValue">导致此异常的参数值。</param>
        /// <returns><see cref="ArgumentOutOfRangeException"/> 对象。</returns>
        public static ArgumentOutOfRangeException ArgumentNegative([InvokerParameterName] string paramName, object actualValue)
        {
            Contract.Ensures(Contract.Result<ArgumentOutOfRangeException>() != null);
        ...
        /// </summary>
        /// </overloads>
        public static ArgumentOutOfRangeException ArgumentOutOfRange([InvokerParameterName] string paramName, object actualValue)
        {
            Contract.Ensures(Contract.Result<ArgumentOutOfRangeException>() != null);
        ...
        public static ArgumentOutOfRangeException ArgumentOutOfRange([InvokerParameterName] string paramName, object actualValue, object begin, object end)
        {
        ...
        /// <returns><see cref="ArgumentOutOfRangeException"/> 对象。</returns>
        public static ArgumentOutOfRangeException InvalidThreshold([InvokerParameterName] string paramName, object actualThreshold)
        {
            Contract.Ensures(Contract.Result<ArgumentOutOfRangeException>() != null);
        ...
        private static string Format([NotNull] string message, [NotNull] params object[] args)
        {
            Contract.Requires(!string.IsNullOrEmpty(message) && args != null && args.Length > 0 && args.All(item => item != null));
        ...
        private static string Format([CanBeNull] object value)
        {
            if (value == null)
            {
                return "(null)";
        ...
        /// <summary>
        /// Checks the argument negative.
        /// </summary>
        /// <param name="paramName">Name of the parameter.</param>
        /// <param name="index">The index.</param>
        public static void CheckArgumentNegative([InvokerParameterName] string paramName, int index)
        {
            if (index < 0)
            {
                throw ArgumentNegative(paramName, index);
            }
        }

        /// <summary>
        /// Checks the argument out of range.
        /// </summary>
        /// <param name="paramName">Name of the parameter.</param>
        /// <param name="index">The index.</param>
        /// <param name="outOfRangeCheck">The out of range check.</param>
        public static void CheckArgumentOutOfRange([InvokerParameterName] string paramName, int index, [NotNull] Func<bool> outOfRangeCheck)
        {
            CheckArgumentNull(outOfRangeCheck);
            if (outOfRangeCheck())
            {
                throw ArgumentOutOfRange(paramName, index);
            }
        }
    }
}
