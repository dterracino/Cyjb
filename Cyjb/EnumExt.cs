...
namespace Cyjb
{
    ...
    public static class EnumExt
    {
        ...
        /// 枚举类型的缓存。
        /// </summary>
        private static readonly ICache<Type, EnumCache> _enumCaches = CacheFactory.Create<Type, EnumCache>("Cyjb.EnumDescriptionCache") ?? new LruCache<Type, EnumCache>(256);
        ...
        private static EnumCache GetEnumCache(Type enumType)
        {
            ...
            return _enumCaches.GetOrAdd(enumType,
                type =>
                {
