...
namespace UnitTestCyjb
{
    ...
    public class UnitTestConvert
    {
        ...
        private static void TestConverter<TInput, TOutput>(TInput[] inputValues,
            Func<TInput, TOutput> checkedConverter,
            Func<TInput, TOutput> uncheckedConverter)
        {
        ...
        private static readonly BindingFlags[] bindingFlagsValues =
        {
        ...
        public void TestEnumConversion()
        {
            ...
            TestConverter(new[] { Tristate.False, Tristate.True, Tristate.NotSure },
                v => (BindingFlags)v,
                v => (BindingFlags)v);
        ...
        {
            private int V;
            public static readonly UserStruct Default = new UserStruct { V = 10 };

            public static explicit operator int(UserStruct s)
            {
                return 10;
            }

            public static explicit operator UserStruct(int s)
            {
                return Default;
            }
        }
        ...
        {
            public static readonly UserBaseClass Default = new UserBaseClass();

            public static explicit operator int(UserBaseClass s)
            {
                return 10;
            }

            public static explicit operator UserBaseClass(int s)
            {
                return Default;
            }
        }
        ...
        {
            public new static readonly UserSubClass Default = new UserSubClass();
        }

        private struct UserMultiStruct
        {
            private string Name;
            public static readonly UserMultiStruct Default = new UserMultiStruct { Name = "Default" };
            public static readonly UserMultiStruct Byte = new UserMultiStruct { Name = "Byte" };
            public static readonly UserMultiStruct Int32 = new UserMultiStruct { Name = "Int32" };
            public static readonly UserMultiStruct UInt64 = new UserMultiStruct { Name = "UInt64" };

            public static explicit operator byte(UserMultiStruct s)
            {
                return 1;
            }

            public static explicit operator UserMultiStruct(byte s)
            {
                return Byte;
            }

            public static explicit operator int(UserMultiStruct s)
            {
                return 2;
            }

            public static explicit operator UserMultiStruct(int s)
            {
                return Int32;
            }

            public static explicit operator ulong(UserMultiStruct s)
            {
                return 3;
            }

            public static explicit operator UserMultiStruct(ulong s)
            {
                return UInt64;
            }
        ...
        {
            private int V;
            public static readonly UserNullableStruct Default = new UserNullableStruct { V = 10 };

            public static explicit operator int?(UserNullableStruct s)
            {
                return 10;
            }

            public static explicit operator UserNullableStruct(int? s)
            {
                return Default;
            }

            public static explicit operator string(UserNullableStruct s)
            {
                return "";
            }

            public static explicit operator UserNullableStruct(string s)
            {
                return Default;
            }
        }
